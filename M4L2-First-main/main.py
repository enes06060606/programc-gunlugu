    ...
    if request.method == 'POST':
        ...
        for user in users_db:
            if form_login == user.login and form_password == user.password:
                return redirect('/index')  # Doğru giriş olursa yönlendir
        
        # Eğer döngü bittiyse ve giriş yapılmadıysa hata mesajı döndür
    ...
    return render_template('login.html', error=error)
                ...
                #Görev #4. Kullanıcıyı yetkilendir
                  ...
                  # Giriş başarılıysa yönlendirme yap
                    # Aksi halde hata mesajı göster ve giriş sayfasını tekrar yükle
